...
int m_tick(struct r* rs, int* rslen, bool keyW, bool keyA, bool keyS, bool keyD, bool keySpace) {
	...
	// Render everything
	struct r button1_r = {
		.source_x=82, .source_y=2564, .source_w=112, .source_h=17,
		.dest_x=550, .dest_y=10,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r text_start_r = {
		.source_x=82, .source_y=2564+17, .source_w=55, .source_h=17,
		.dest_x=550, .dest_y=10,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r button2_r = {
		.source_x=82, .source_y=2564, .source_w=112, .source_h=17,
		.dest_x=550, .dest_y=10+20,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r text_options_r = {
		.source_x=82, .source_y=2564+2*17, .source_w=55, .source_h=17,
		.dest_x=550, .dest_y=10+20,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r button3_r = {
		.source_x=82, .source_y=2564, .source_w=112, .source_h=17,
		.dest_x=550, .dest_y=10+40,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r text_quit_r = {
		.source_x=82, .source_y=2564+3*17, .source_w=55, .source_h=17,
		.dest_x=550, .dest_y=10+40,
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
	struct r highlight_r = {
		.source_x=82+(14*(menu_hltime > 10)), .source_y=2564-17, .source_w=16, .source_h=17,
		.dest_x=550, .dest_y=10+(20*menu_highlight),
		.visible=1, .flip_horizontal=0, .flip_vertical=0
	};
